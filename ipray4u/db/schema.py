...
MIGRATE_PRAYERS_CREATED_AT = """
ALTER TABLE prayers ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ;
ALTER TABLE prayers ALTER COLUMN created_at SET DEFAULT NOW();
"""
